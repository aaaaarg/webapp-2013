...
class AddThingToCollectionsBase(Form):
	...
	"""
	collection = CollectionQuerySetSelectField(u'Collections', label_attr='title', allow_blank=True)
...
AddThingToCollectionsForm = model_form(CollectedThing, base_class=AddThingToCollectionsBase)
